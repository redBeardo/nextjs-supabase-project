...
"[project]/src/utils/supabaseClient.ts [app-client] (ecmascript)": (function(__turbopack_context__) {
...
function SupabaseTestPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SupabaseTestPage.useEffect": ()=>{
            const fetchData = {
                "SupabaseTestPage.useEffect.fetchData": async ()=>{
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('test_table').select('*');
                    if (error) setError(error.message);
                    else setData(data || []);
                }
            }["SupabaseTestPage.useEffect.fetchData"];
            fetchData();
        }
    }["SupabaseTestPage.useEffect"], []);
...
_s(SupabaseTestPage, "nD7edIDRwNLC+/bSdKREAvtAsyY=");
_c = SupabaseTestPage;
var _c;
...
//# sourceMappingURL=_425564b7._.js.map